...
- Previously interning at Autodesk, building the MCP server for bridging Autodesk AI Agents and internal admin APIs
- Previously interning at RBC Consumer Banking, building the credit card application flow for the mobile and web apps
